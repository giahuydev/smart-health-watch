...
import { X, ShoppingCart, Trash, Heart } from "@phosphor-icons/react/dist/ssr";
              ...
              {activeTab === "cart" ? (
                cart.length === 0 ? (
                  ...
                  <div className="flex flex-col gap-6">
                    {cart.map((item, index) => (
                      <div key={`cart-${item.id}-${index}`} className="flex gap-4 items-center bg-slate-50 dark:bg-gray-800/50 p-4 rounded-2xl">
                    ...
                    {wishlist.map((item, index) => (
                      <div key={`wishlist-${item.id}-${index}`} className="flex gap-4 items-center bg-slate-50 dark:bg-gray-800/50 p-4 rounded-2xl">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <Button variant="primary" size="sm" onClick={() => addToCart(item)} className="py-1.5 px-3 text-sm">
                            Thêm vào giỏ
                          </Button>
                        </div>
                        <button 
                          ...
                          className="p-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-full transition-colors self-start"
                        >
